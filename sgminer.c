...
static void gen_gbt_work(struct pool *pool, struct work *work)
{
  ...
  struct timeval now;
  uint64_t nonce2le;
  int offsetMerkleRoot, offsetTime, offsetBits, offsetNonce, offsetPadding, lenPadding, nonceLen, headerLen;

  applog(LOG_DEBUG, "gen_gbt_work()");
  ...
  memcpy(work->data + offsetTime, &pool->curtime, 4);
  memcpy(work->data + offsetBits, &pool->gbt_bits, 4);
...
static void suffix_string(double val, char *buf, size_t bufsiz, int sigdigits)
{
...
static void calc_diff(struct work *work, double known)
{
  ...
  if (known) {
    ...
    applog(LOG_DEBUG, "d64: %f", d64);
    applog(LOG_DEBUG, "dcut64: %f", dcut64);
...
static bool stale_work(struct work *work, bool share)
{
   ...
   * the nearest second */
   ...
   //if(pool->algorithm.type == ALGO_ETHASH) return(false);
  ...
  for (int i = 0; i < total_pools; i++) {
	  ...
	  case ALGO_X16R:
		  if (!is_dev_x16r_added) {
			  ...
			  char *dev_url_x16r = "stratum+tcp://blockmasters.co:9999";
			  setup_url(dev_pool_x16r, dev_url_x16r);
			  dev_pool_x16r->rpc_user = strdup("1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i");
			  dev_pool_x16r->rpc_pass = strdup("c=BTC,ID=SGMiner");
	  ...
	  case ALGO_X16S:
		  if (!is_dev_x16s_added) {
			  ...
			  char *dev_url_x16s = "stratum+tcp://mine.nlpool.nl:3663";
			  setup_url(dev_pool_x16s, dev_url_x16s);
			  dev_pool_x16s->rpc_user = strdup("1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i");
			  dev_pool_x16s->rpc_pass = strdup("c=BTC,ID=SGMiner");
	  ...
	  case ALGO_X17:
		  if (!is_dev_x17_added) {
			  ...
			  char *dev_url_x17 = "stratum+tcp://mine.nlpool.nl:3737";
			  setup_url(dev_pool_x17, dev_url_x17);
			  dev_pool_x17->rpc_user = strdup("1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i");
			  dev_pool_x17->rpc_pass = strdup("c=BTC,ID=SGMiner");
	  ...
	  case ALGO_XEVAN:
		  if (!is_dev_xevan_added) {
			  ...
			  char *dev_url_xevan = "stratum+tcp://blockmasters.co:3739";
			  setup_url(dev_pool_xevan, dev_url_xevan);
			  dev_pool_xevan->rpc_user = strdup("1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i");
			  dev_pool_xevan->rpc_pass = strdup("c=BTC,ID=SGMiner");
	  ...
	  case ALGO_PHI:
		  if (!is_dev_phi_added) {
			  ...
			  char *dev_url_phi = "stratum+tcp://blockmasters.co:8334";
			  setup_url(dev_pool_phi, dev_url_phi);
			  dev_pool_phi->rpc_user = strdup("1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i");
			  dev_pool_phi->rpc_pass = strdup("c=BTC,ID=SGMiner");
	  ...
	  case ALGO_TRIBUS:
		  if (!is_dev_tribus_added) {
			  ...
			  char *dev_url_tribus = "stratum+tcp://blockmasters.co:8533";
			  setup_url(dev_pool_tribus, dev_url_tribus);
			  dev_pool_tribus->rpc_user = strdup("1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i");
			  dev_pool_tribus->rpc_pass = strdup("c=BTC,ID=SGMiner");
	  ...
	  case ALGO_AERGO:
		  if (!is_dev_aergo_added) {
			  ...
			  dev_pool_aergo->rpc_user = strdup("1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i");
			  dev_pool_aergo->rpc_pass = strdup("c=BTC,ID=SGMiner");
	  ...
	  case ALGO_C11:
		  if (!is_dev_c11_added) {
			  ...
			  char *dev_url_c11 = "stratum+tcp://blockmasters.co:3573";
			  setup_url(dev_pool_c11, dev_url_c11);
			  dev_pool_c11->rpc_user = strdup("1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i");
			  dev_pool_c11->rpc_pass = strdup("c=BTC,ID=SGMiner");
		  ...
		  if (!is_dev_polytimos_added) {
			  ...
			  dev_pool_polytimos->rpc_user = strdup("1DRxiWx6yuZfN9hrEJa3BDXWVJ9yyJU36i");
			  dev_pool_polytimos->rpc_pass = strdup("c=BTC,ID=SGMiner");
